...
public class PetController {
  ...
  public ResponseContext findPetsByStatus(
  ...
  public ResponseContext getPetById(
    final RequestContext request,
    final Long petId
  ) {
    if (petId == null) {
  ...
  public ResponseContext updatePetWithForm(
    final RequestContext request,
    final Long petId,
    final String name,
    final String status
    ...
    return new ResponseContext().contentType(outputType).entity(existingPet);
  }

  public ResponseContext deletePet(
    final RequestContext request,
    final String apiKey,
    final Long petId
  ) {
    ...
    if (null == pet) {
      ...
      return new ResponseContext()
        ...
        .entity("Pet couldn't be deleted.");
    }
  }

  public ResponseContext uploadFile(
    final RequestContext request,
    final Long petId,
    final String apiKey,
    final File file
    ...
    if (null != pet) {
      ...
      return new ResponseContext()
        .status(Response.Status.NOT_MODIFIED)
        .entity("Pet couldn't be updated.");
    }
  }
  ...
  public ResponseContext updatePet(
    final RequestContext request,
    final Pet pet
  ) {
    if (pet == null) {
  ...
  public ResponseContext findPetsByTags(
    final RequestContext request,
